...
We evaluated the algorithm using 1,000 random origin–destination pairs, comparing the shortest-path baseline against safest alternatives across a range of allowable detour and 
junction-risk constraints ~\citep{NateraOrozco2020}.
