...
Under a no-special-risk baseline, crash incidence is assumed proportional to exposure, yielding the expected number of crashes and crashes for a given street-segment $i$ aggregated over time.
\[
\widehat{C}_{i}
