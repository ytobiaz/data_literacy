...
As described in \cref{sec:methods}, the relative risk $r_i$ was computed for each segment and junction.  
Due to the high variance in the crash data, the shrinkage parameter was small ($\widehat{\alpha} = 0.129$), resulting in limited regularization and a wide spread of $r_i$ estimates. These were mapped as partly shown in \cref{fig:junction_details} (a).  
