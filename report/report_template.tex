...
\begin{figure*}[ht]
  \centering
  \includegraphics{figs/paneljunction.pdf}
  \caption{\textbf{Closer investigation on Junction 2482}
  As one example the junction on Hermann Hesse and Heinrich Mann Straße was observed further.
  ...
  Looking at Google Street view \ref{} this seems to make sense since the car lane is crossing the bicyle lane in this place.
  }
  \label{fig:junc}
\end{figure*}
